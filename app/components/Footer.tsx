...
export default function Footer() {
  return (
    <footer className="bg-[#0b5e36] text-white pt-16 pb-8 mt-auto border-t-4 border-[#D4AF37] font-sans overflow-hidden w-full">
        ...
        <div className="col-span-1 md:col-span-2 flex flex-col sm:flex-row items-start sm:items-center gap-6">
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              <button className="bg-black border border-gray-700 rounded-lg px-4 py-2.5 flex items-center gap-3 hover:bg-gray-900 transition-colors shadow-sm">
              ...
              <button className="bg-black border border-gray-700 rounded-lg px-4 py-2.5 flex items-center gap-3 hover:bg-gray-900 transition-colors shadow-sm">
                <svg viewBox="0 0 384 512" className="w-5 h-5 fill-current text-white" xmlns="http://www.w3.org/2000/svg">
