  ...
  return (
    <div className="font-sans flex flex-col bg-[#f4f5f7] min-h-screen">
      ...
      <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row px-4 gap-6 flex-grow pb-10">
        ...
        {/* Left Sidebar Menu */}
        <aside className="hidden md:block w-[240px] flex-shrink-0 bg-white border border-gray-200 rounded shadow-sm h-fit">
        ...
        <main className="flex-1 overflow-hidden">
          ...
          <div className="bg-white p-5 rounded shadow-sm border border-gray-200 mb-6 flex space-x-6 overflow-x-auto scrollbar-hide items-start">
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-end mb-6 border-b border-gray-200 pb-4 gap-4">
            <h1 className="text-2xl font-bold text-gray-800 tracking-tight">KSA, Saudi Arabia, Saudi - <span className="text-green-600">{selectedCity} offers</span></h1>
          ...
          {/* Flyers Grid Layout (Perfect for Desktop) */}
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-8">
            {flyers.map((flyer) => (
              <div key={flyer.id} className="bg-white rounded border border-gray-200 shadow-sm hover:shadow-lg transition-all duration-300 cursor-pointer group flex flex-col relative">
                ...
                <div className="relative aspect-[3/4] bg-gray-50 border-b border-gray-100 overflow-hidden rounded-t">
                  ...
                  <div className="absolute -bottom-6 right-3 w-12 h-12 bg-white rounded shadow-md border border-gray-200 p-1 z-10 flex items-center justify-center">
