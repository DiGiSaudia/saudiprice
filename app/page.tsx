...
export default function Home() {
  ...
  useEffect(() => {
    ...
    fetchProducts();
  }, [selectedCity]); // Re-fetch or re-filter if city changes
  ...
  return (
    <div className="font-sans flex flex-col bg-[#f4f5f7] min-h-screen">
      ...
      <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row px-4 gap-6 flex-grow pb-10">
        ...
        {/* Standardized Left Sidebar Menu */}
        ...
        <main className="flex-1 overflow-hidden">
          ...
          {/* New Requested Heading and Top Tabs */}
          ...
          {/* Responsive Flyers Grid Layout (Fixed Display Issues) */}
